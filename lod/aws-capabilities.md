...
|[Amazon CloudWatch](https://docs.aws.amazon.com/IAM/latest/UserGuide/list_amazoncloudwatch.html)|cloudwatch|currently supported|||
|[Amazon CloudWatch Events](https://docs.aws.amazon.com/IAM/latest/UserGuide/list_amazoncloudwatchevents.html)|events|currently supported|||
|[Amazon CloudWatch Logs](https://docs.aws.amazon.com/IAM/latest/UserGuide/list_amazoncloudwatchlogs.html)|logs|currently supported|||
...
|[Amazon DynamoDB Accelerator (DAX)](https://docs.aws.amazon.com/IAM/latest/UserGuide/list_amazondynamodbacceleratordax.html)|dax|currently supported|||
[Amazon EC2](https://docs.aws.amazon.com/IAM/latest/UserGuide/list_identityandaccessmanagement.html)|ec2|currently supported|||
|[Amazon EC2 Container Registry](https://docs.aws.amazon.com/IAM/latest/UserGuide/list_amazonec2containerregistry.html)|ecr|currently supported|||
|[Amazon EC2 Container Service](https://docs.aws.amazon.com/IAM/latest/UserGuide/list_amazonec2containerservice.html)|ecs|currently supported|||
...
|[Amazon GameLift](https://docs.aws.amazon.com/IAM/latest/UserGuide/list_amazongamelift.html)|gamelift|planned|||
...
|[Amazon MQ](https://docs.aws.amazon.com/IAM/latest/UserGuide/list_amazonmq.html)|mq|planned|||
|[Amazon Neptune](https://docs.aws.amazon.com/IAM/latest/UserGuide/list_amazonneptune.html)|neptune-db|planned|||
|[Amazon Pinpoint](https://docs.aws.amazon.com/IAM/latest/UserGuide/list_amazonpinpoint.html)|mobiletargeting|planned|||
|[Amazon Polly](https://docs.aws.amazon.com/IAM/latest/UserGuide/list_amazonpolly.html)|polly|planned|||
...
|[Amazon WorkDocs](https://docs.aws.amazon.com/IAM/latest/UserGuide/list_amazonworkdocs.html)|workdocs|planned|||
...
|[AWS CloudHSM](https://docs.aws.amazon.com/IAM/latest/UserGuide/list_awscloudhsm.html)|cloudhsm|planned|||
|[AWS Cloud9](https://docs.aws.amazon.com/IAM/latest/UserGuide/list_awscloud9.html)|N/A|currently supported|||
|[AWS CloudFormation](https://docs.aws.amazon.com/IAM/latest/UserGuide/list_awscloudformation.html)|cloudformation|currently supported|||
|[AWS CloudTrail](https://docs.aws.amazon.com/IAM/latest/UserGuide/list_awscloudtrail.html)|cloudtrail|currently supported|||
|[AWS CodeBuild](https://docs.aws.amazon.com/IAM/latest/UserGuide/list_awscodebuild.html)|codebuild|planned|||
|[AWS CodeCommit](https://docs.aws.amazon.com/IAM/latest/UserGuide/list_awscodecommit.html)|codecommit|planned|||
|[AWS CodeDeploy](https://docs.aws.amazon.com/IAM/latest/UserGuide/list_awscodedeploy.html)|codedeploy|planned|||
...
|[AWS Elemental MediaStore](https://docs.aws.amazon.com/IAM/latest/UserGuide/list_awselementalmediastore.html)|mediastore|planned|||
|[AWS Firewall Manager](https://docs.aws.amazon.com/IAM/latest/UserGuide/list_awsfirewallmanager.html)|fms|planned|||
|[AWS Glue](https://docs.aws.amazon.com/IAM/latest/UserGuide/list_awsglue.html)|glue|planned|||
|[AWS Greengrass](https://docs.aws.amazon.com/IAM/latest/UserGuide/list_awsgreengrass.html)|greengrass|planned|||
...
|[AWS IoT](https://docs.aws.amazon.com/IAM/latest/UserGuide/list_awsiot.html)|iot|planned|||
|[AWS IoT Analytics](https://docs.aws.amazon.com/IAM/latest/UserGuide/list_awsiotanalytics.html)|iotanalytics|currently supported|||
|[AWS IoT 1-Click](https://docs.aws.amazon.com/IAM/latest/UserGuide/list_awsiot1-click.html)|iot1click|planned|||
|[AWS Lambda](https://docs.aws.amazon.com/IAM/latest/UserGuide/list_awslambda.html)|lambda|currently supported|||
|[AWS Key Management Service](https://docs.aws.amazon.com/IAM/latest/UserGuide/list_awskeymanagementservice.html)|N/A|currently supported|||
|[AWS Marketplace](https://docs.aws.amazon.com/IAM/latest/UserGuide/list_awsmarketplace.html)|aws-marketplace-management|planned|||
|[AWS Marketplace Management Portal](https://docs.aws.amazon.com/IAM/latest/UserGuide/list_awsmarketplacemanagementportal.html)|aws-marketplace|planned|||
...
|[Auto Scaling Plans](https://docs.aws.amazon.com/IAM/latest/UserGuide/list_awsbatch.html)|autoscaling-plans|currently supported|||
|[Data Pipeline](https://docs.aws.amazon.com/IAM/latest/UserGuide/list_datapipeline.html)|datapipeline|planned|||
|[Elastic Load Balancing](https://docs.aws.amazon.com/IAM/latest/UserGuide/list_elasticloadbalancing.html)|elasticloadbalancing|currently supported|||
|[Elastic Load Balancing V2](https://docs.aws.amazon.com/IAM/latest/UserGuide/list_elasticloadbalancingv2.html)|elasticloadbalancing|currently supported|||
|[Identity And Access Management](https://docs.aws.amazon.com/IAM/latest/UserGuide/list_identityandaccessmanagement.html)|iam|currently supported|||
|[Manage Amazon API Gateway](https://docs.aws.amazon.com/IAM/latest/UserGuide/list_manageamazonapigateway.html)|apigateway|currently supported|||
...
|[Virtual Private Cloud](https://aws.amazon.com/vpc/?hp=tile&so-exp=below)|ec2|currently supported|||
