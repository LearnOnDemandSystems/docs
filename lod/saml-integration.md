...
The following is an example of how to configure your Azure AD to support SSO authentication via SAML.  While this example is for Azure AD, any SAML Identity Provider should work.
