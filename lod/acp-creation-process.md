...
The lab instance ID is added to the resource group properties as a tag. 
   ...
   ![](images/AzureResourceGroupTags.png)
...
- Determine whether your ACP mitigates risk appropriately and is acceptable: [Cloud Security Standards](https://docs.skillable.com/lod/cloud-security/cloud-security-standards.md "Cloud Security Standards")
