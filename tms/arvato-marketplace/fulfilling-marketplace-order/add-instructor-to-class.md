...
You can add an instructor to a class when you are creating or editing a class. You may need to [create the instructor](#create-an-instructor-from-a-class) user account, however, if the instructor already has a user account in the TMS, you may simply [add them](#add-an-instructor-to-a-class) to the class.
...
1. For additional information on using the lab interface and preparing for class, please read the articles for instructor in the [**Help**](/tms/home.md) library.
