...
- **Discussion** - assigns a discussion to the course. See [What is a discussion and how can I use it to increase student interaction in their learning?](../discussions/what-is-discussion.md) for more information on discussions.
...
1. [How do I add an LTI Resource link to my course?](../other-activities/add-lti-resource-link.md)
