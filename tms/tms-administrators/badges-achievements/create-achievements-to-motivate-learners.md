...
1. Click the **Conditions** tab and enter the JSON conditions for earning the achievement (see [Writing conditions for achievements: JSON Help and Examples](tms-achievement-conditions.md).)
1. Click **Save**.
