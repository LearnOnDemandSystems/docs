...
- [Create a Lab Profile](lod/feature-focus/lab-profiles/settings.md)
...
- [Lab on Demand edX Integration (LTI)](guides/lti/lod-lti.md)

- [Life Cycle Actions](lod/feature-focus/lab-profiles/life-cycle-actions.md)

- [Performance Based Testing (PBT)](guides/pbt/lodpbtguide.md)

- [Shared Labs](guides/sl/sharedlabs.md)

- [Virtual Machine Based Lab Development - Best Practices](lod/vm-based-lab-build-best-practices.md)

- [Deploy a Linux VM on Azure using a Resource Template](lod/quick-starts/linux/deploy-linux-template.md)
